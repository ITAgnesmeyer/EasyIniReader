...
namespace EasyIniReader
{
    ...
    public class IniReaderApi
    {
        ...
        public IniReaderApi(string fileName)
        {
        ...
        public string GetIniValueString(string appName, string key, string defaultValue = "")
        {
            ...
            uint len = NativeMethods.GetPrivateProfileStringW(appName, key, defaultValue, sb, 255, this.FileName);
            return sb.ToString();
        }
        ...
        {
            TestFile();
            return (int) NativeMethods.GetPrivateProfileIntW(appName, key, defaultValue, this.FileName);
        }
        ...
        {
            TestFile();
            return NativeMethods.WritePrivateProfileString(appName, key, value, this.FileName);
        }
